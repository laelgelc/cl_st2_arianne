...
def main():
    ...
    # Gather all corpus/06_* folders
    folders = sorted(INPUT_BASE.glob("06_*"))
    if not folders:
        print("No folders found under corpus/06_*. Exiting.")
        return
    ...
    for folder in folders:
        ...
        #   "06_clean_human"
        #   "06_clean_persona_gpt"
        #   "06_plain_gemini"
        #
        # 1. Remove "06_"
        suffix = folder.name[3:]  # everything after "06_"
