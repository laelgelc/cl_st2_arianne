...
The corpus comes from an climate-change discourse study project in which world-leading climate-change 
NGO Greenpeace blog posts are analysed. The corpus includes:
• Human authored Greenpeace blog posts
• Synthetic blog posts generated by GPT, Grok, and Gemini

The LLM-generated responses were produced under one prompting regime: a persona prompt, in which 
the LLM should incorporate a writer for the world-leading climate-change NGO Greenpeace.
